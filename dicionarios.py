...
palavras_positivas = {
    ...
    "gostei": 2.8, "legal": 4.5, "incrível": 3.1, "positivo": 2.6, "espetacular": 4.3,
    ...
    "esperançoso": 3.1, "resplandecente": 4.9, "saudável": 2.4, "fabuloso": 3.6, "to foda": 4.6, "fodastico": 5.9,
    ...
    "chave": 4.6, "topzera": 6.8, "zica": 5.4, "de boa": 2.8, "poderoso": 5.1, "filé": 3.1, "file": 3.2,
    "estrela": 5.5, "show de bola": 5.8, "quebrado": 4.9, "fenômeno": 6.7, "divonico": 5.2
}

palavras_negativas = {
    "ruim": -7, "péssimo": -5, "horrível": -9, "triste": -7, "mal": -6, "desagradável": -6, 
    ...
    "irritante": -6, "insustentável": -8, "preocupante": -7, "chato": -6, "nocivo": -7, "pior": -5,
    "lamentável": -8, "abominável": -9, "dificuldade": -6, "desagradável": -7,"mau":-6,
    "mermão": -6, "fui": -5, "lixado": -7, "decepcionado": -7, "se fudeu": -8, "deu ruim": -7,
    "quebrado": -6, "travado": -5, "sujeira": -8, "vazio": -6, "ferrado": -8, "merda": -9, 
    "bomba": -7, "fudido": -9, "fora": -6, "falido": -7, "acabou": -6, "desapontado": -7, 
    "sem graça": -6, "sinistro": -7, "chato": -5, "sacanagem": -8, "zica": -7, "ralado": -6, "dor": -5, "dores": -4, "merda": -7
}
...
palavras_neutras = {
    ...
    "vou ver depois", "não é urgente", "mais ou menos"
}


palavras_negacao = {
    "não", "nao", "nunca", "jamais", "nenhum", "ninguém", "sem", "ausência", "nada", "nenhuma",
...
atenuadores = {
    "pouco", "um pouco", "levemente", "ligeiramente", "um pouco", "raramente", "ocasionalmente", 
    ...
    "moderado", "morno", "dificilmente", "relativamente", "até", "ate"
}
